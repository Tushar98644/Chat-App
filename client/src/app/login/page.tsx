...
const LoginPage = () => {
    ...
    const loginwithgoogle = () => {
        router.push('https://localhost:8000/auth/google');
    }
    const loginwithgithub = () => {
        router.push('https://localhost:8000/auth/github');
    }
    const loginwithapple = () => {
        router.push('https://localhost:8000/auth/apple');
    }
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8 flex flex-col items-center justify-center">
                        ...
                        <div className="relative inline-flex  group">
                            ...
                            <a href="#" title="Get quote now"
                                className="relative inline-flex gap-4 items-center justify-center px-8 py-4 text-md font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                                role="button" onClick={loginwithgoogle}>
                        ...
                        <div className="relative inline-flex  group">
                            ...
                            <a href="#" title="Get quote now"
                                className="relative inline-flex gap-4 items-center justify-center px-8 py-4 text-md font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                                role="button" onClick={loginwithgithub}>
